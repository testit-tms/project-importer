...
namespace TestIT.AdaptersApi.Model
{
    ...
    public partial class AutoTestCreateApiModel : IValidatableObject
    {
        ...
        public AutoTestCreateApiModel(Guid projectId = default, string externalId = default, string externalKey = default, string name = default, string varNamespace = default, string classname = default, string title = default, string description = default, bool? isFlaky = default, LayerApiModel layer = default, List<AutoTestStepApiModel> steps = default, List<AutoTestStepApiModel> setup = default, List<AutoTestStepApiModel> teardown = default, bool? shouldCreateWorkItem = default, List<LabelApiModel> labels = default, List<LinkCreateApiModel> links = default, List<string> tags = default)
        {
