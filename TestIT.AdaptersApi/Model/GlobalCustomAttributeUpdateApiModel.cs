...
namespace TestIT.AdaptersApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GlobalCustomAttributeUpdateApiModel")]
    public partial class GlobalCustomAttributeUpdateApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalCustomAttributeUpdateApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlobalCustomAttributeUpdateApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalCustomAttributeUpdateApiModel" /> class.
        /// </summary>
        ...
        public GlobalCustomAttributeUpdateApiModel(string name = default, List<CustomAttributeOptionUpdateApiModel> options = default, bool? isEnabled = default, bool? isRequired = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GlobalCustomAttributeUpdateApiModel and cannot be null");
            }
            this.Name = name;
        ...
        public List<CustomAttributeOptionUpdateApiModel> Options { get; set; }
