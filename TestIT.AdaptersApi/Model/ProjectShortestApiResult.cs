...
namespace TestIT.AdaptersApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectShortestApiResult")]
    public partial class ProjectShortestApiResult : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectShortestApiResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectShortestApiResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectShortestApiResult" /> class.
        /// </summary>
        ...
        public ProjectShortestApiResult(Guid id = default, bool isDeleted = default, long globalId = default, string name = default, ProjectTypeModel type = default)
        {
            this.Id = id;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ProjectShortestApiResult and cannot be null");
            }
            this.Name = name;
            this.Type = type;
        }
