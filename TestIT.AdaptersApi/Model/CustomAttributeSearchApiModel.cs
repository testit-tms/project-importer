...
namespace TestIT.AdaptersApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomAttributeSearchApiModel")]
    public partial class CustomAttributeSearchApiModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAttributeSearchApiModel" /> class.
        /// </summary>
        ...
        public CustomAttributeSearchApiModel(string name = default, List<Guid> projectIds = default, List<Guid> customAttributeIds = default, List<CustomAttributeType> customAttributeTypes = default, bool? isGlobal = default, bool? isDeleted = default)
        {
            this.Name = name;
        ...
        public List<CustomAttributeType> CustomAttributeTypes { get; set; }
